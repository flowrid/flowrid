    ...
    <div className="max-w-[1460px] mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-text-secondary mb-8">
          Your 3PL matching dashboard. We will help you find the perfect fulfillment partner.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-sm text-text-secondary">Search and compare 2,800+ verified 3PL providers across the US.</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-text-secondary">Get matched with the best 3PL for your specific needs.</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-text-secondary">Side-by-side comparison of your shortlisted providers.</p>
          </Link>
        </div>
