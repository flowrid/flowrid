...
const NAV_ITEMS = [
  ...
  { label: "Products", href: "/saas/products", icon: "/icons/inventory.png" },
  { label: "Inventory", href: "/saas/inventory", icon: "/icons/inventory.png" },
  { label: "Clients", href: "/saas/clients", icon: "/icons/orders.png" },
  { label: "Warehouses", href: "/saas/warehouses", icon: "/icons/inventory.png" },
  { label: "Users", href: "/saas/users", icon: "/icons/settings.png" },
  { label: "Receiving", href: "/saas/receiving", icon: "/icons/receiving.png" },
  { label: "Returns", href: "/saas/returns", icon: "/icons/receiving.png" },
  { label: "Reports", href: "/saas/reports", icon: "/icons/analytics.png" },
  { label: "Dock", href: "/saas/dock", icon: "/icons/shipping.png" },
  { label: "Automation", href: "/saas/automation", icon: "/icons/settings.png" },
  { label: "Audit", href: "/saas/audit", icon: "/icons/settings.png" },
