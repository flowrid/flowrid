...
export default async function InventoryPage() {
  ...
  return (
    <div>
      ...
      <CrossSell3PL title={t("tools.inventory.crossSell.title")} description={t("tools.inventory.crossSell.description")} browseAllLabel={t("tools.inventory.crossSell.browseAll")} browseAllDesc={t("tools.inventory.crossSell.browseAllDesc")} />
