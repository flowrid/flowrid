...
export default async function AutomationPage() {
  ...
  return (
    <div>
      ...
      <CrossSell3PL title={t("tools.automation.crossSell.title")} description={t("tools.automation.crossSell.description")} browseAllLabel={t("tools.automation.crossSell.browseAll")} browseAllDesc={t("tools.automation.crossSell.browseAllDesc")} />
