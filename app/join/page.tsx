    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary mt-2">Join Flowrid to find your perfect 3PL match.</p>
        </div>

        <button
          onClick={handleGoogleSignUp}
          className="w-full flex items-center justify-center gap-3 bg-white border border-border rounded-xl px-4 py-3 text-text hover:bg-gray-50 transition-colors font-medium mb-6"
        >
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs text-text-secondary uppercase tracking-wider">Or use email</span>
          <div className="flex-1 h-px bg-border" />
        </div>
