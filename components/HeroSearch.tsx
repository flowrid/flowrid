...
const HERO_IMAGES = [
  { src: "/images/hero/Perfect 3PL Match.webp", altKey: "home.heroImg1" as const },
  { src: "/images/hero/Full-Network Comparison.webp", altKey: "home.heroImg2" as const },
  { src: "/images/hero/Warehouse Fit.webp", altKey: "home.heroImg3" as const },
  { src: "/images/hero/Guaranteed Logistics Stabillty.webp", altKey: "home.heroImg4" as const },
];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 w-full max-w-[560px]">
            <div className="grid grid-cols-2 gap-2">
              {HERO_IMAGES.map((img) => (
                <div key={img.altKey} className="relative overflow-hidden rounded-xl">
                  <img
                    src={img.src}
                    alt={t(img.altKey)}
