...
export default function ReportsContent() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-[1280px]">
      <h1 className="text-[28px] font-bold tracking-tight text-[#1D1D1F] mb-6">Reports</h1>

      <div className="bg-white rounded-2xl shadow-sm border border-black/5 p-6 mb-6">
        <div className="flex flex-wrap items-end gap-4">
          <div>
            <label className="block text-[11px] font-medium text-[#86868B] uppercase mb-1">Report Type</label>
          ...
          <div>
            <label className="block text-[11px] font-medium text-[#86868B] uppercase mb-1">Period</label>
